...
if [ ! -e "$FIRST_START_DONE" ]; then
  ...
  if [ "${REGISTRY_LDAP_AUTH_LDAP_CLIENT_TLS,,}" == "true" ]; then
    ...
    ssl-helper ${LDAP_CLIENT_SSL_HELPER_PREFIX} "${CONTAINER_SERVICE_DIR}/ldap-client/assets/certs/${REGISTRY_LDAP_AUTH_LDAP_CLIENT_TLS_CRT_FILENAME}" "${CONTAINER_SERVICE_DIR}/ldap-client/assets/certs/${REGISTRY_LDAP_AUTH_LDAP_CLIENT_TLS_KEY_FILENAME}" "${CONTAINER_SERVICE_DIR}/ldap-client/assets/certs/${REGISTRY_LDAP_AUTH_LDAP_CLIENT_TLS_CA_CRT_FILENAME}"
